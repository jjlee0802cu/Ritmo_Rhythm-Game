...
public class BlockColumn {
	...
	public void translate(int windowWidth, int windowHeight) {
		for(Throw gesture : collection) {
			gesture.translate(windowWidth, windowHeight);
		}
		checkCollision();
	}
	...
	/**
	 * Gets whether or not there is a tie collision detected between the Throws within the ThrowCollection
	 * @return Whether or not there is a tie collision detected between the Throws within the ThrowCollection
	 */
	public boolean getTieCollisionDetected() {
		return tieCollisionDetected;
	}
	...
	private ArrayList<Throw> collection;
