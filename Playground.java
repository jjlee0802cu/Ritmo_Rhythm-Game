...
public class Playground extends Applet {
	...
	public void init() {
		...
		b1 = new Block(getWidth(), getHeight());
		createTimer();
	}
	...
	private void createTimer() {
		...
		appletTimer = new Timer(htmlDelay, new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				b1.translate(getWidth(), getHeight());
//				collection.translate(getWidth(), getHeight());		
...
//				}	
	...
	//private ThrowCollection collection;
	private Block b1;
